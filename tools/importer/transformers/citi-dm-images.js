...
/**
 * Transformer: Citi DM/Scene7 images.
 * Converts Dynamic Media <img> tags into anchors so URLs survive markdown round-trip.
 * Runs in afterTransform only (block parsers need <img> during beforeTransform).
 *
 * Detected Scene7 URLs from migration-work/metadata.json .images.mapping:
 *   - https://s7d9.scene7.com/is/image/citiqa3/MeetHomeStory
 *   - https://s7d9.scene7.com/is/image/citiqa3/Quotation%20(3)
 *   - https://s7d9.scene7.com/is/image/citiqa3/allYouNeedBuyingHome
 *   - https://s7d9.scene7.com/is/image/citiqa3/cds-dollar
 *   - https://s7d9.scene7.com/is/image/citiqa3/cds-home-1
 *   - https://s7d9.scene7.com/is/image/citiqa3/cds-mortgage-budget
 *   - https://s7d9.scene7.com/is/image/citiqa3/cds-purchase-rate
 *   - https://s7d9.scene7.com/is/image/citiqa3/cds-savings-1
 *   - https://s7d9.scene7.com/is/image/citiqa3/zillowIcon
 */
